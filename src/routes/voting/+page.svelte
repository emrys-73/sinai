<script>
    ...
    let songs = [
      ...
      { name: 'Danke Gott', tempo: 'fast', language: 'german', age: 'new', votes: 2 },
      { name: 'Ich weiss dass mein erlöser lebt', tempo: 'fast', language: 'german', age: 'new', votes: 0 },
      { name: 'Lupta', tempo: 'fast', language: 'romanian', age: 'new', votes: 1 },
      { name: 'Frei!', tempo: 'fast', language: 'german', age: 'new', votes: 2 },
      { name: 'Jehova Nissi', tempo: 'fast', language: 'romanian', age: 'new', votes: 1 },
      { name: 'Only Jesus', tempo: 'fast', language: 'romanian', age: 'old', votes: 4 },
      { name: 'This is amazing grace', tempo: 'fast', language: 'romanian', age: 'old', votes: 0 },
      { name: 'Praise', tempo: 'fast', language: 'romanian', age: 'new', votes: 4 },
      { name: 'Vereint', tempo: 'slow', language: 'german', age: 'new', votes: 1 },
      { name: 'Dankbarkeit (Gratitude)', tempo: 'slow', language: 'german', age: 'new', votes: 3 },
      { name: 'No longer slaves', tempo: 'slow', language: 'romanian', age: 'old', votes: 2 },
      { name: 'Fii intronat in Laude', tempo: 'slow', language: 'romanian', age: 'old', votes: 0 },
      { name: 'Centrul vietii', tempo: 'slow', language: 'romanian', age: 'new', votes: 1 },
      { name: 'Sehnsucht', tempo: 'slow', language: 'german', age: 'old', votes: 3 },
      { name: 'Tu domnesti', tempo: 'slow', language: 'romanian', age: 'old', votes: 1 },
      { name: 'Holy Forever', tempo: 'slow', language: 'romanian', age: 'old', votes: 2 },
      { name: 'Yahweh se manifesta', tempo: 'slow', language: 'romanian', age: 'old', votes: 3 },
      { name: 'Poala Hainei Tale', tempo: 'slow', language: 'romanian', age: 'old', votes: 1 },
      { name: 'The Blood', tempo: 'slow', language: 'german', age: 'old', votes: 3 },
      { name: 'Ich schaffe Raum', tempo: 'slow', language: 'german', age: 'old', votes: 5 },
      { name: 'This is a move', tempo: 'slow', language: 'romanian', age: 'old', votes: 0 },
      { name: 'Dom al treziri', tempo: 'slow', language: 'romanian', age: 'old', votes: 1 },
      { name: 'Toată Inima', tempo: 'slow', language: 'romanian', age: 'old', votes: 0 }
    ];
